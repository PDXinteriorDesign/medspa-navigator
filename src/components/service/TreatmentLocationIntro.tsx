...
interface TreatmentLocationIntroProps {
  serviceName: string;
  locationName: string;
}

const TreatmentLocationIntro = ({ serviceName, locationName }: TreatmentLocationIntroProps) => {
...
export default TreatmentLocationIntro;
