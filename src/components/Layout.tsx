  ...
  return (
    <div className="flex flex-col min-h-screen bg-medspa-cream/30">
      <Helmet>
        ...
        <meta property="og:url" content="https://www.medspasnyc.com" />
        ...
        <meta property="og:image" content="https://www.medspasnyc.com/og-image.png" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://www.medspasnyc.com" />
        ...
        <meta property="twitter:image" content="https://www.medspasnyc.com/og-image.png" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "MedSpasNYC",
            "url": "https://www.medspasnyc.com",
            "potentialAction": {
              "@type": "SearchAction",
              "target": "https://www.medspasnyc.com/search?q={search_term_string}",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "name": "MedSpasNYC",
            "url": "https://www.medspasnyc.com",
            "logo": "https://www.medspasnyc.com/favicon.svg",
            "sameAs": [
