...
const HamptonsLanding = () => {
  ...
  return (
    <>
      <LocationHeroOnly
        name="The Hamptons"
        imageUrl="https://images.unsplash.com/photo-1717257523926-a77937869941?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
