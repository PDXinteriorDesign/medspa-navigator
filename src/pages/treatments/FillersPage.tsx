...
const FillersPage = () => {
  ...
  const enhancedContent = {
    ...
    process: [
      `Your dermal filler journey begins with a thorough consultation at one of our vetted NYC medical spas. Your provider will assess your facial anatomy, discuss your aesthetic goals, and recommend specific fillers for your unique concerns.`,
    ...
    recovery: [
      `One of the advantages of getting dermal fillers in NYC is the minimal downtime. Most patients return to normal activities immediately, though some providers recommend avoiding strenuous exercise for 24 hours.`,
    ...
    results: [
      `Dermal fillers provide immediate volume restoration and structural support, with results continuing to improve as any post-treatment swelling resolves.`,
    ...
    considerations: [
      `Dermal filler pricing in New York varies significantly based on the product used, the provider's expertise, and the clinic location. In premium Manhattan locations, expect to pay $800-$1,200 per syringe, with most treatments requiring 1-3 syringes.`,
